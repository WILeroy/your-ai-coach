...
await page.goto('https://127.0.0.1/login', { waitUntil: 'networkidle' })
...
await page.goto('https://127.0.0.1/coach', { waitUntil: 'networkidle' })
await page.waitForTimeout(1500)
await page.screenshot({ path: '/tmp/shot-dashboard.png' })
// 移动端
const m = await browser.newPage({ viewport: { width: 390, height: 844 } })
await m.goto('https://127.0.0.1/coach', { waitUntil: 'networkidle' })
